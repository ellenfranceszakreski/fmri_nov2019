...
matlabbatch{2}.cfg_basicio.file_dir.file_ops.file_fplist.filter = '^ce_ausub\d+_run1\.nii';
...
matlabbatch{3}.cfg_basicio.file_dir.file_ops.file_fplist.filter = '^ce_ausub\d+_run2\.nii';
...
matlabbatch{4}.cfg_basicio.file_dir.file_ops.file_fplist.filter = '^ce_ausub\d+_run3\.nii';
...
matlabbatch{6}.cfg_basicio.file_dir.file_ops.file_fplist.filter = '^ce_mean\w+\.nii';
...
matlabbatch{7}.spm.spatial.coreg.estimate.source(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^ce_mean\w+\.nii)', substruct('.','val', '{}',{6}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{7}.spm.spatial.coreg.estimate.other(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^ce_ausub\d+_run1.nii)', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{7}.spm.spatial.coreg.estimate.other(2) = cfg_dep('File Selector (Batch Mode): Selected Files (^ce_ausub\d+_run2.nii)', substruct('.','val', '{}',{3}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{7}.spm.spatial.coreg.estimate.other(3) = cfg_dep('File Selector (Batch Mode): Selected Files (^ce_ausub\d+_run3.nii)', substruct('.','val', '{}',{4}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
...
matlabbatch{8}.spm.spatial.coreg.write.ref(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^sub\d+_n3_nlm.nii)', substruct('.','val', '{}',{5}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{8}.spm.spatial.coreg.write.source(1) = cfg_dep('Coregister: Estimate: Coregistered Images', substruct('.','val', '{}',{7}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','cfiles'));
matlabbatch{8}.spm.spatial.coreg.write.roptions.interp = 7;
matlabbatch{8}.spm.spatial.coreg.write.roptions.wrap = [0 0 0];
matlabbatch{8}.spm.spatial.coreg.write.roptions.mask = 0;
matlabbatch{8}.spm.spatial.coreg.write.roptions.prefix = 'cw_';
