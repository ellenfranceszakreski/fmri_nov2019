...
# get code from git hub repository named 'fmri_nov2019'

AnalysisDir=/data/scratch/zakell/fmri_nov2019 # make sure this is correct (name should not have any spaces)
...
# clone github files (MAKE SURE THIS IS CORRECT REPOSITORY!)
git clone https://github.com/ellenfranceszakreski/fmri_nov2019 --depth 1 --branch=master $GithubDir
